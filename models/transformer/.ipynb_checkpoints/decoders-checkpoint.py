...
#             input,print(out.shape)#torch.Size([5, 59, 512])
#             enc_output,print(encoder_output.shape)#torch.Size([5, 28, 28, 512])
#             mask_pad,print(mask_queries.shape)#torch.Size([5, 59, 1])
#             mask_self_att,print(mask_self_attention.shape)#torch.Size([5, 1, 59, 59])
#             mask_enc_att,print(mask_encoder.shape)#torch.Size([5, 1, 1, 28])
...
#             print('第'+str(i)+'个decoder')
#             print(out.shape)#torch.Size([5, 59, 512])
#             print(encoder_output.shape)#torch.Size([5, 28, 28, 512])
#             print(mask_queries.shape)#torch.Size([5, 59, 1])
#             print(mask_self_attention.shape)#torch.Size([5, 1, 59, 59])
#             print(mask_encoder.shape)#torch.Size([5, 1, 1, 28])
